...
public class DrivetrainCharacterizationCommand extends CommandBase {
  ...
  public DrivetrainCharacterizationCommand(Drivetrain drivetrain) {
  ...
  public void execute() {
    ...
    m_drivetrain.setOutput(leftVoltage, rightVoltage);
    ...
    m_numberArray[5] = m_drivetrain.getLeftDistanceMeters();
    m_numberArray[6] = m_drivetrain.getRightDistanceMeters();
    m_numberArray[7] = m_drivetrain.getLeftVelocity();
    m_numberArray[8] = m_drivetrain.getRightVelocity();
    m_numberArray[9] = Math.toRadians(m_drivetrain.getIMUYaw());
