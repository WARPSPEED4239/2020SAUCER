...
public class CommandRight extends SequentialCommandGroup {
  ...
  public CommandRight(StartingPosition startingPosition, TargetTask targetTask, Joystick joystick, AngleAdjust angleAdjust, Drivetrain drivetrain, FeederWheels feederWheels, Hopper hopper, IntakeMotors intakeMotors, IntakePistons intakePistons, Limelight limelight, PneumaticController pneumaticController, Ramp ramp, Shooter shooter, Turret turret) {
    switch (targetTask) {
      case Shoot3:
